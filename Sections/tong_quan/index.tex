...
\subsection{Một số luồng chính}
\begin{figure}[H]
	\centering
	\includegraphics[width=10cm]{Images/diagram/Customer_flow}
	\vspace{0.5cm}
	\caption{Activy diagram: Khách hàng}
	\label{fig:my_label}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=7cm]{Images/diagram/Schedule_flow}
    \vspace{0.5cm}
    \caption{Activy diagram: Quản lý lịch}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=15cm]{Images/diagram/Kitchen_flow}
    \vspace{0.5cm}
    \caption{Activy diagram: Quản lý bếp}
    \label{fig:my_label}
\end{figure}
\input{Sections/tong_quan/functional_spec/index}

% \subsection{Yêu cầu chất lương}

% \input{Sections/tong_quan/yeucau}
