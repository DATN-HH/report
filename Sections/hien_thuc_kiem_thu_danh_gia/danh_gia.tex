...
\hline
\endfirsthead
\caption[]{Scheduling Module (continued)}\\
\hline
\textbf{Chức năng} & \textbf{Trạng thái} \\
\hline
\endhead
...
\item \textbf{POS (Point of Sale) Module}

\begin{longtable}{|p{10cm}|c|}
\caption{POS (Point of Sale) Module}\\
\hline
\textbf{Chức năng} & \textbf{Trạng thái} \\
\hline
\endfirsthead
\caption[]{POS (Point of Sale) Module (continued)}\\
\hline
\textbf{Chức năng} & \textbf{Trạng thái} \\
\hline
\endhead
\multicolumn{2}{|l|}{\textbf{POS – Ăn tại chỗ}} \\ \hline
...
Chia hóa đơn (theo món hoặc theo người) &  \\ \hline
\multicolumn{2}{|l|}{\textbf{POS – Mang về}} \\ \hline
...
Thanh toán mang về (tiền mặt, thẻ, ví điện tử) & \checkmark \\ \hline
\multicolumn{2}{|l|}{\textbf{POS – Giao hàng}} \\ \hline
...
Ghi nhận thanh toán khi giao hàng (COD) &  \\ \hline
\end{longtable}
...
\hline
\endfirsthead
\caption[]{Đặt bàn \& Pre-order (continued)}\\
\hline
\textbf{Chức năng} & \textbf{Trạng thái} \\
\hline
\endhead
...
\begin{table}[h!]
    \centering
    \caption{Tổng hợp kết quả đánh giá Google Lighthouse}
    \label{tab:lighthouse-results}
    \begin{tabular}{|l|c|c|c|c|}
    \hline
    \textbf{Trang được đánh giá} & \textbf{Performance} & \textbf{Accessibility} & \textbf{Best Practices} & \textbf{SEO} \\ \hline
    Trang chủ (Homepage) & 97 & 89 & 96 & 100 \\ \hline
    Kitchen Display System (KDS) & 100 & 94 & 100 & 100 \\ \hline
    Trang Menu & 79 & 91 & 100 & 100 \\ \hline
    POS - Quản lý bàn & 88 & 88 & 100 & 100 \\ \hline
    Pre-Order & 98 & 91 & 100 & 100 \\ \hline
    Table Booking & 85 & 88 & 100 & 100 \\ \hline
    \hline
    \textbf{Điểm trung bình} & \textbf{91.2} & \textbf{90.2} & \textbf{99.3} & \textbf{100} \\ \hline
    \end{tabular}
\end{table}
