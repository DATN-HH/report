...
% \begin{tabular}{c}
% \multicolumn{1}{c}{\textbf{{\fontsize{15}{1}\selectfont{BÁO CÁO}}}}\\
% \\{\textbf{{\fontsize{15}{1}\selectfont{ĐỒ ÁN TỐT NGHIỆP}}}}
% \end{tabular}
\end{center}
...
% & &  \textbf{\fontfamily{ptm}\fontsize{15}{1}\selectfont{TKHĐ: TRƯỜNG QUỲNH CHI }}
% \vspace{6pt}
\\
...
% \begin{tabular}{lrl}
% \hspace{2cm} 
% & HỘI ĐỒNG: & \textbf{KHOA HỌC MÁY TÍNH 9} 
% \vspace{6pt}
% \\
% & THƯ KÝ HỘI ĐỒNG: & \textbf{NGUYỄN THANH TÙNG} 
% \vspace{6pt}
% \\

% & GIẢNG VIÊN HƯỚNG DẪN: & \textbf{THS. ĐỖ THANH THÁI}
% \vspace{2pt}
% \\
% & & \textbf{ASSOC. PROF. TRẦN MINH QUANG} 
% \vspace{6pt}
% \\

% & SINH VIÊN THỰC HIỆN: &   \textbf{NGUYỄN MẬU MINH ĐỨC - 2010230}
% \vspace{2pt}
% \\
% & & \textbf{LÝ GIA HUY - 2010289}
% \vspace{2pt}
% \\
% & & \textbf{PHẠM HOÀNG ĐỨC HUY - 2011286}
% \vspace{2pt}
% \\
